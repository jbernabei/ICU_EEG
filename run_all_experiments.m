...
run_adaptive = 1; % Set to 1 to run adaptive learning
...
if train_ML
    ...
    % Save results
    save('Models/model_struct_3_sec.mat','model_struct','partition_sz','partition_nsz','partition_iic','-v7.3')
...
%     load('Results/adaptive_struct_knn-x_fold.mat')
    ...
    [semi_nsz_TN, x, y, z, w] = compute_metrics(nsz_list, 2, semi_adaptive_struct);
